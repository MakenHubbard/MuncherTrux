...
class EditEvent extends React.Component {
  ...
  render () {
    ...
    return (
      <div id="editEventFormBack">
        <div id="editEventForm">
          <h1 id="editEventTitle">Edit Event</h1>
          <form className="form-horizontal">
            ...
            <div className="form-group">
              <div className="col-sm-offset-2 col-sm-10">
                <button type="submit" className="btn btn-default saveEditBtn" onClick={this.saveThisNewEditEvent}>Save This Edit</button>
              </div>
            </div>
          </form>
        </div>
